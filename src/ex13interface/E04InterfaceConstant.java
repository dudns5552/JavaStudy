...
/*
인터페이스에 변수를 정의하면 무조건 정적 상수가 되므로 이를 "인터페이스형 상수"
라고 한다. 프로그램에서 설정값이나 명시적인 코드를 위해 사용된다.
 */

/*
해당 인터페이스의 접근지정자는 default이므로 해당 패키지를 벗어나면 사용할
수 없다. 만약 프로젝트 전체에서 사용하고 싶다면 public으로 선언해야한다. */
//interface Game {
...
public class E04InterfaceConstant {
	...
	public static void main(String[] args) {
		...
		모두 기억하기 힘들 수 있으므로 명시적인 단어를 통해 상수를
		사용하면 코드의 가독성이 높아진다. */
		case Game.SCISSORS:
