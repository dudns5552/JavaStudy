...
class Police {
	/*
	권총과 수갑을 보유한 경찰을 추상화하기 위해
	상속하지 않고 멤버변수로 정의하고 있다. */
	//수갑 : 일반적인 멤버변수
	int handCuffs;
	//권총 : 인스턴스형 멤버변수
	Gun gun;
	...
	//권총을 발사하는 행위 표현
	public void shut() {
		//조건문을 사용하여 소유한 총이 있을때만 발사할 수 있도록 설정
		if(gun == null) {
