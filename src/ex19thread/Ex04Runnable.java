...
class Sum {
	...
	/*
	메서드 호출시 전달되는 인순의 값을 누적해서 멤버변수에 더한다.
...
class AdderThread extends Sum implements Runnable {
	...
	public void run() {
		/*
		멤버변수 start에서 end까지 반복하면서 부모클래스의 addNum을
		호출하여 누적합을 계산한다. start가 1이고 end가 10이라면
...
public class Ex04Runnable {
	...
	public static void main(String[] args) {
		...
		System.out.println("1~1000까지의 합 : "+ (at1.getNum()
				+ at2.getNum()));
	}
