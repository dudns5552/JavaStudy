...
형식)
	...
	- 만약 break문이 없다면 그 아래의 모든 문장이 실행된다.
	- default문은 앞에서 모든 case와 일치되지 않을 때 실행되는 부분으로
	  if 문의 else와 동일한 역할을 한다.
 */
...
public class E02Switch {
	...
	public static void main(String[] args) {
		...
		- int, char, String을 사용할 수 있다.(byte, short도 가능)
		- 논리식, 비교식을 사용할 수 없다.
		 */
//		long ln = 100;
//		switch(ln) { //long 타입 사용불가 int만 사용가능
//		case 100:
