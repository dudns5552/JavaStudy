...
//자식클래스 : 기본 스피커에 베이스의 기능을 보강(추가)한 형태로 정의
...
public class E01Overriding {
	...
	public static void main(String[] args) {
		...
		//자식클래스의 참조변수로 부모인턴스를 참조할 순 없다.
//		BaseSpeaker baseSpeaker2 = new Speaker(); //에러발생
		
		/*
		단, 부모타입의 변수로 자식 인스턴스를 참조하면 접근할 수 있는범위가
		부모인스턴스로 제한된다. 따라서 자식쪽에 정의된 stBase()는
		호출할 수 없다. */
