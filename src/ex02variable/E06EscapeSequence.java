...
//		System.out.println("나는 "개발자"가 되고싶어요");
		System.out.println("나는 \"개발자가\"가 되고싶어요"); //'도 동일
		
		//printf() : 문자열을 서식에 맞춰 출력할때 사용(print format)
		...
		/* 같은 출력문장이지만 println()을 사용하면 아래와 같이 문자열과
		   변수를 분리해서 기술해야 하므로 조금 더 복잡하다.*/
		System.out.println("\n국어 : " + kor + ", 영어 : " + eng
				+ ", 수학 : " + math);
		
		/* 실수는 %f를 사용. 또한 정수와 실수의 연산이므로 결과는 실수가
		   반환되어 double 타입으로 선언한 변수에 대입한다.*/
		...
		System.out.printf("국어:%6d, 영어:%6d, 수학:%6d, "
				+ " 평균:%12.4f %n", kor, eng, math, avg);
		System.out.printf("국어:%-6d, 영어:%-6d, 수학:%-6d,"
				+ " 평균:%-12.2f %n", kor, eng, math, avg);
