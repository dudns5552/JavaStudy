...
public class E07TypeCasting {
	...
	public static void main(String[] args) {
		...
		/*
		아래 코드는 자동형변환은 아니다. CPU는 int보다 작은 자료형을 연산할때
		int로 간주하여 진행하고 결과로 int로 반환한다.
...
//		char ch1 = b1;
		...
		char ch3 = 'A', ch4;
		int num4 = 2;
		//char + int => int이므로 char에 저장할 수 없어 에러발생.ㅣ
//		ch4 = ch3 + num4; 정상적으로 사용하려면 int ch4_1 = ch3 + num4;
		ch4 = (char)(ch3 + num4);
