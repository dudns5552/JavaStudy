...
class ChildProperty {
	...
	public ChildProperty(int balls) {
		this.balls = balls;
	}
	
	void obtainBead(ChildProperty other, int balls) { //인스턴스를 지정하고, 서로 상호작용을 하여 구슬이 교환
		this.balls = this.balls + balls;
		other.balls = other.balls - balls;
		
	}
	
	void showProperty() {
		System.out.println("보유 구슬의 개수 "+ balls);
	}
